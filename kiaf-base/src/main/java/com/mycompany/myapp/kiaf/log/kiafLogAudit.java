...
public class kiafLogAudit extends DefaultAuditLog {
    ...
    public boolean accept(AuditEvent auditEvent) {
        return auditEvent.getAuditContext().getControllerClass().getPackage().getName().startsWith("com.mycompany.myapp.kiaf");
    }
...
//            logTempDTO.setMethodArgs(args); //字段可能超长，所以只存zip的值
